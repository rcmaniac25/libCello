...
#ifdef __QNX__
  var f = stream_open($(File, NULL), "./data/test.bin", "w");
#else
...
#ifdef __QNX__
  f = stream_open($(File, NULL), "./data/test.bin", "r");
#else
...
#ifdef __QNX__
  var f0 = new(File, $(String, "./data/test.bin"), $(String, "w"));
#else
...
#ifdef __QNX__
  stream_open(f0, "./data/test.txt", "w");
#else
...
#ifdef __QNX__
  stream_open(f0, "./data/test.txt", "r");
#else
